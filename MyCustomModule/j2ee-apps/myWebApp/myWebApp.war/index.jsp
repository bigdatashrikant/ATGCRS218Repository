...
<head><title>myWebApp JSP Index Page</title></head>
<body>
<h1>myWebApp Test JSP Page</h1>
Welcome to the myWebApp!  
<p>
...
<%-- @version $Id: //product/Eclipse/version/11.3.1/plugins/atg.project/templates/index.jsp#1 $$Change: 1497274 $--%>
